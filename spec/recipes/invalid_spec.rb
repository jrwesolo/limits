...
describe 'limits_test_cookbook::invalid' do
  ...
  it do
    is_expected.to create_limits_config('invalid_with_extension.conf')
      .with(
        limits: [
  ...
  it do
    is_expected.to create_directory('conf directory for invalid_with_extension.conf')
      .with(
  ...
  it do
    is_expected.to create_template('/etc/security/limits.d/invalid_with_extension.conf')
      .with(
        cookbook: 'limits',
  ...
  it do
    is_expected.to render_file('/etc/security/limits.d/invalid_with_extension.conf')
      .with_content(
      <<-EOF
